...
import { EXPENSE_CATEGORIES, PAYMENT_MODES } from "@/constants/lookups";
...
export function ExpenseForm({ onSubmit, isSubmitting, onCancel, defaultValues }: ExpenseFormProps) {
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="flex flex-col gap-[6px]">
          ...
          <select {...register("category")} className="input" aria-label="Category">
      ...
      <Input
        ...
        placeholder="e.g. Chicken Purchase, Gas Cylinder"
        {...register("items")}
      ...
      <div className="flex gap-3 pt-2">
        ...
        <Button fullWidth type="submit" loading={isSubmitting}>Save Expense</Button>
      </div>
    </form>
  );
}
